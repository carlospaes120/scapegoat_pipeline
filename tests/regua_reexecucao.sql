...
-- Saida: tabela, metrica, chave, valor (texto). Comparar linha a linha com tests/regua_reexecucao.md.
-- Nenhum conta_id, handle ou texto sai desta consulta: so agregados.
